        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center md:text-left">
            ...
            <div class="space-y-3">
                ...
                <p class="text-slate-500 text-xs leading-relaxed max-w-[250px] mx-auto md:mx-0">
                    Providing accurate lotto results and statistical analysis for the Filipino community.
                </p>
            </div>

            <div>
                <h4 class="font-bold text-white text-sm mb-4 uppercase tracking-wider">Quick Links</h4>
            ...
            <div>
                <h4 class="font-bold text-white text-sm mb-4 uppercase tracking-wider">Disclaimer</h4>
...
<script>
    // Just in case you need the auto-year script
