        ...
        <aside class="w-full lg:w-[320px] shrink-0">
            <div class="lg:sticky lg:top-6 bg-slate-800 rounded-2xl p-6 border border-slate-700 shadow-2xl">
                ...
                <div class="space-y-6">
                    ...
                    <!-- NEW: Selection Mode Buttons (Doubles/Triples) -->
                    <div id="selectionModeContainer" class="hidden">
                        <label class="block text-[10px] uppercase tracking-widest text-slate-500 font-black mb-2 ml-1">Selection Mode</label>
        ...
        <main class="flex-1 min-w-0 space-y-6">
            ...
            <div class="bg-slate-800 rounded-2xl border border-slate-700 shadow-xl overflow-hidden">
                <div class="px-6 py-4 border-b border-slate-700 flex justify-between items-center">
                    ...
                    <span id="checkCountBadge" class="text-xs text-slate-400 font-medium">0 matches found</span>
                </div>
