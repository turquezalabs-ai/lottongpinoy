...
export function getColdOverdueInsight(gameData) {
    // FIX: Lowered threshold from 30 to 10
    if (gameData.length < 10) return null;
    const lastSeen = {};
    ...
    // FIX: Lowered gap requirement from 15 to 5
...
export function getSukiPairsInsight(gameData) {
    ...
    // FIX: Lowered requirement from 3 to 2
...
// ==========================================
// 5. HELPER: RANDOM TEXT (USED BY CARDS.JS)
// ==========================================
